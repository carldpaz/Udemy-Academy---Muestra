                            ...
                            <div class="tab-pane" id="login_credentials">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="new_password"> <?php echo get_phrase('change_password'); ?></label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" name = "new_password" id="new_password" placeholder="<?php echo get_phrase('enter_new_password'); ?>">
                                            </div>
                                        </div>
                                    </div> <!-- end col -->
                                </div> <!-- end row -->
