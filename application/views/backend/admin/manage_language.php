                ...
                <div class="tab-content">
                    ...
                    <?php if (isset($edit_profile)):
                        ...
                        <div class="tab-pane show active" id="edit" style="padding: 30px">
                            <div class="row">
                                <table class="table table-bordered" id="table-phrases_list">
                                    <thead>
                                    <tr>
                                        <th><span>Frase</span></th>
                                        <th><span>Traducción</span></th>
                                        <th>-</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <?php foreach (openJSONFile($edit_profile) as $key => $value): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" name="updated_phrase" value="<?php echo $value; ?>" id = "phrase-<?php echo $key; ?>" data-key="<?php echo $key; ?>">
                                            </td>
                                            <td>
...
<script type="text/javascript">
    ...
    let table_phrase = document.getElementById('table-phrases_list');

    if (table_phrase){

        table_phrase.addEventListener('keyup', e => {
            let element = e.target;
            if (element.tagName === 'INPUT') {
                if(e.key === 'Enter'){
                    updatePhrase(element.dataset.key);
                }
            }
        }, false);
    }
